...
# Print the position and velocity equations
...
theta_1_func = sp.lambdify(t, sp.rad(30 * t))  # theta_1(t) = 30t degrees to radians
theta_2_func = sp.lambdify(t, sp.rad(45 * t))  # theta_2(t) = 45t degrees to radians
theta_3_func = sp.lambdify(t, sp.rad(60 * t))  # theta_3(t) = 60t degrees to radians
theta_4_func = sp.lambdify(t, sp.rad(90 * t))  # theta_4(t) = 90t degrees to radians
theta_5_func = sp.lambdify(t, sp.rad(0 * t))  # theta_5(t) = 0t degrees to radians
...
# Substitute numerical values into the position and velocity equations
...
# Evaluate the numerical position and velocity
